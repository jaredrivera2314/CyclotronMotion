...
def a1(angle1pos,angle1velocity,angle2pos,angle2velocity):
    aa1=-((g*m1.m*angle1pos)+(g*m2.m*(angle1pos-angle2pos))+(m2.m*(angle1pos-angle2pos)*(m1.armlength*(angle1velocity**2)+m2.armlength*(angle2velocity**2))))/(m1.armlength*m1.m)
    return aa1

def a2(angle1pos,angle1velocity,angle2pos,angle2velocity):
    aa2=((angle1pos-angle2pos)*(g*(m1.m+m2.m)+m1.armlength*(m1.m+m2.m)*(angle1velocity**2)+m2.armlength*m2.m*(angle2velocity**2)))/(m2.armlength*m1.m)
    return aa2
